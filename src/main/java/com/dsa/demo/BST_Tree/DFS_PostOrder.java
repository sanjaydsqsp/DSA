//BST: DFS PostOrder
//Create a DFSPostOrder method within a BinaryTree class that performs a depth-first search (post-order traversal) of the tree and returns an ArrayList of the visited nodes' values in the order they were visited.
//
...
//
//
//I have also provided an alternative solution in the "Solution Explanation" section that employs a separate recursive helper method rather than using an inner
